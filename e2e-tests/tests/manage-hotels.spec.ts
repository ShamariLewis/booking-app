...
test.beforeEach(async ({ page }) => {
  ...
  await page.locator("[name=email]").fill("test_register_67335@test.com");
...
// Test our Add Hotel functionality
test("should allow user to add a hotel", async ({ page }) => {
  ...
  await page.setInputFiles('[name="imageFiles"]', [
    path.join(__dirname, "files", "pexels-asadphoto-1268855.jpg"),
    path.join(__dirname, "files", "pexels-enginakyurt-1579253.jpg"),
  ]);
